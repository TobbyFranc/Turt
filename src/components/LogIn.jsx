  ...
  return (
    <div className="flex  ">
        <div className="m-auto w-full max-w-md p-8 space-y-3 rounded-xl bg-white shadow-lg">
            <h1 className="text-2xl font-bold text-center text-[var(--primaryColor)]">Login to Your Account</h1>
        ...
        <div className="hidden lg:block w-1/2 h-screen bg-[var(--backgroundColor)]">
            ...
            <div className="flex justify-center items-center h-[calc(100vh-64px)]">
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Travel" className="w-full h-full object-cover rounded-l-xl"/> 
            </div>
        </div>
        {/*  */}
    </div>
