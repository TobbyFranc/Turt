...
const LocationInfo = ({ locationData, trendingToday = [] }) => {
  ...
  return (
    <div className="max-w-6xl px-4 mt-40 md:mt-28 mb-6 ">
      ...
      <p className="text-[var(--textColor)] flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[var(--primaryColor)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {trendingToday.length > 0 && (
        <div className="mt-6">
          <h4 className="text-xl font-semibold text-[var(--accentColor)] mb-2">Trending Today</h4>
          <ul className="list-disc pl-5 text-[var(--textColor)]">
            {trendingToday.map((trend, index) => (
