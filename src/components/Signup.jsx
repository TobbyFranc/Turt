        ...
        <div className="m-auto w-full max-w-md p-8 space-y-3 rounded-xl bg-white shadow-lg">
            ...
            <form action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                <div className="space-y-1 text-sm">
                    ...
                    <input type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-gray-300 focus:border-[var(--primaryColor)] focus:ring-[var(--primaryColor)] focus:outline-none"/>
                </div>
                <div className="space-y-1 text-sm">
                ...
                <button className="block w-full p-3 text-center rounded-sm text-white bg-[var(--accentColor)] hover:bg-yellow-600"><a href="/Login">Sign up</a></button>
            </form>
            <p className="text-xs text-center sm:px-6 text-gray-600">Already have an account? 
                <a href="/Login" className="underline text-[var(--primaryColor)] font-semibold"> Login</a>
            </p>
        </div>
        {/*  */}
